  ...
  <div class="container">
      <ul class="navbar-nav">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="view_student_patient.php"><i class="fas fa-eye"></i> View Students</a>
        </li>
      </ul>
  </div>
</nav>
				...
				<div>
					<div class="card card-body-margins">
						...
						<?php while($row = mysqli_fetch_array($result)) { ?>
							...
							<th><a href="../modules/add_physical_examination_patient.php?id=<?php echo $row['id']; ?>"><i class="fas fa-plus"></i> Add Physical Examination</a></th>
						</tr>	
