  ...
  <div class="container">
      <ul class="navbar-nav">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="../view_patient_profile/medical_profile_records.php?id=<?php echo $id ?>">Employee Medical Profile Records</a>
        </li>
      </ul>
  </div>
</nav>
 	...
 	?>
		...
		<div class="col-md-9">
			...
			<div style="margin-top: 5px;">
				<a href="../modules/emp_medical_profile.php?id=<?php echo $row['id']; ?>"><i class="fas fa-plus"></i> Add Medical Profile</a>
			</div>
		<?php 
